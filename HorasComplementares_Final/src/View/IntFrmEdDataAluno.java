 ...
 * @author Dood
 */
public class IntFrmEdDataAluno extends javax.swing.JInternalFrame {
    HorasComplementaresController controller;
    String idUsuario;
    /**
     * Creates new form IntFrmCadAluno
     */
    public IntFrmEdDataAluno(String idUsuario) {
        initComponents();
        this.idUsuario=idUsuario;
        controller = new HorasComplementaresController();
        cNome.setText(controller.select("SELECT aluno.nome FROM aluno WHERE(aluno.idAluno=" + idUsuario + ")", "nome"));
        cCpf.setText(controller.select("SELECT aluno.cpf FROM aluno WHERE(aluno.idAluno=" + idUsuario + ")", "cpf"));
        cEmail.setText(controller.select("SELECT aluno.email FROM aluno WHERE(aluno.idAluno=" + idUsuario + ")", "email"));
        cEndereco.setText(controller.select("SELECT aluno.endereco FROM aluno WHERE(aluno.idAluno=" + idUsuario + ")", "endereco"));
        cMatricula.setText(controller.select("SELECT aluno.Matricula FROM aluno WHERE(aluno.idAluno=" + idUsuario + ")", "Matricula"));
        cSemestre.setText(controller.select("SELECT aluno.Semestre FROM aluno WHERE(aluno.idAluno=" + idUsuario + ")", "Semestre"));
        cSenha.setText(controller.select("SELECT aluno.senha FROM aluno WHERE(aluno.idAluno=" + idUsuario + ")", "senha"));
        cTelefone.setText(controller.select("SELECT aluno.telefone FROM aluno WHERE(aluno.idAluno=" + idUsuario + ")", "telefone"));
    }
    ...
    private void btCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btCadastrarActionPerformed
        controller.editaAluno(cMatricula.getText(),cSemestre.getText(),cNome.getText(),cEndereco.getText(),cCpf.getText(),cTelefone.getText(),cEmail.getText(),cSenha.getText(),this.idUsuario);
        dispose();
